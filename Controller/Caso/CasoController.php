<?php
    ...
    class CasoController {
        ...
        public function postFinalize(){
            ...
            $sql = "UPDATE tbl_caso SET cas_fotografia_fin = '".$cas_fotografia_fin."', cas_observacion = '".$observacion."', estado_id = 5, cas_prioridad = 1, usuario_id = 1 WHERE cas_id = ".$cas_id."";
