<?php 
    ...
    class VisorController{
        ...
        function __construct(){
            $this->objetoModel = new VisorModel();
        }

        public function getMap(){
            
            include_once '../View/Visor/VisorCali.php';
        }
        ...
        public function indexPoint(){
            ...
            $consultaCoordenadas = $this->objetoModel->consultar($sqlCoordenadas);
            ...
            while($coordenadas = pg_fetch_assoc($consultaCoordenadas)){
                ...
                if($cx >= ($coordenadas['coordenadax']-50) && $cx <= ($coordenadas['coordenadax']+50)){
                    ...
                    if($cy >= ($coordenadas['coordenaday']-50) && $cy <= ($coordenadas['coordenaday']+50)){
                        ...
                        $consultaCoincidencia = $this->objetoModel->consultar($sqlCoincidencia);
                        ...
                        $casoConsultado = $this->objetoModel->consultar($sqlCaso);
                        $deteriorosConsulta = $this->objetoModel->consultar($sqlCasoDeterioro);
                        if($casoConsultado){
                            //echo "se encontro un caso";
                            while($casoEncontrado = pg_fetch_assoc($casoConsultado)){
                                include_once '../View/Visor/ContenidoConsulta.php';
