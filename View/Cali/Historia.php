     ...
     <section id="Quienes" class="quienes">
       ...
       <div class="row">
           ...
           <div class="col-lg-12 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            ...
            <h3 class="text-center">Algo sobre el origen</h3>
            
            <br>

            En la revisión de documentos que reposan en el Fondo Cabildo–Concejo del Archivo Histórico de Cali AHC, respecto a la fundación de la ciudad encontramos registros realizados por soldados, frailes y escribanos que hacen referencia a la creación de estos poblados, algunos de estos testimonios nos indican de la compleja conformación social y cultural en estos primeros años. Como bien lo relata Aprile, para el caso de Cali tempranamente en el año 1563, ya es latente la presencia de un
            mestizaje entre españoles, indios y mulatos. Lo que se evidencia en estos primeros testimonios que contienen información de carácter censal:
            ...
            <h3 class="text-center">Proceso de modernización en Cali 1910-1960</h3>
            ...
            <h3 class="text-center">Del crecimiento urbano inusitado al Distrito Especial 1970-2020</h3>
