...
var pixel_img = new Image(); pixel_img.src = '../View/Mapa/misc/img/pixel.gif';
...
//  var _Xclick; var _Yclick;
  ...
  var _iconLoading = '../View/Mapa/misc/img/GifCargando.gif';
...
function pointOverlay( p_icon, p_infoSkin, p_title, p_x, p_y, p_item_name, p_item_value )
{
  ...
  {
    // Create a default Info-window icon object...
    _infoSkin = new msInfoSkin( '../View/Mapa/misc/img/angolo_a.png', '../View/Mapa/misc/img/angolo_b.png',
                                '../View/Mapa/misc/img/angolo_c.png', '../View/Mapa/misc/img/angolo_d.png',
                                '../View/Mapa/misc/img/report_t.png', '../View/Mapa/misc/img/report_d.png',
                                '../View/Mapa/misc/img/report_l.png', '../View/Mapa/misc/img/report_r.png',
                                '../View/Mapa/misc/img/report_x.png', '../View/Mapa/misc/img/close.png',
                                '../View/Mapa/misc/img/report_arrow.png' );
  }
...
function msIcon( p_img, p_shd, p_offsetX, p_offsetY )
{
  ...
  if ( _img_name == null )
  {
    _img_name = '../View/Mapa/misc/img/mm_20_red.png';
    _shd_name = '../View/Mapa/misc/img/mm_20_shadow.png';
    _offsetX  = 6; _offsetY = 19;
  }
  if (_img_name == '') {_img_name='../View/Mapa/misc/img/pixel.gif';}
  if (_shd_name == '') {_shd_name='../View/Mapa/misc/img/pixel.gif';}
...
function msToolbar(p_msMap, _control, _default)
{
  ...
  var _iconFullExtentButton = '../View/Mapa/misc/img/aim.png';
  var _iconZoomboxButton    = '../View/Mapa/misc/img/focus.png';
  var _iconPanButton        = '../View/Mapa/misc/img/move.png';
  var _iconZoominButton     = '../View/Mapa/misc/img/zomax.png';
  var _iconZoomoutButton    = '../View/Mapa/misc/img/zomin.png';
