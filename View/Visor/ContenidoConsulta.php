<div id="Formulario">
                                        ...
                                        <div class="form-row col-md-12">
                                            <label>Causa:</label>
                                            <textarea class="form-control" style="color:black; font-weight:bold;" placeholder="Causa.." rows="4" maxlength="200" readonly><?php echo $casoEncontrado['cas_causa']?></textarea>
                                        </div>
